# Memory Puzzle Game
# Tutorial by Al Sweigert
# http://inventwithpython.com/pygame

import random, pygame, sys
from pygame.locals import *

# Frame per second, the general speed of the program
FPS = 30
...
# Speed for box sliding reveals and cover
REVEALSPEED = 8

# Individual box height and width in pixels
BOXSIZE = 40

# Gap between boxes in pixels
GAPSIZE = 10
...
def splitIntoGroupsOf(groupSize, theList): 
    # Split a list into a list of lists, where the inner lists have
...
def drawBoxCovers(board, boxes, coverage):
    ...
    for box in boxes:
        ...
        if coverage > 0: # only draw the coer if there is a coverage
